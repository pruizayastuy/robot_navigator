...
class Metaclass_AddWaypoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtle_navigator.srv.AddWaypoint')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtle_navigator.srv import _add_waypoint
...
class AddWaypoint(metaclass=Metaclass_AddWaypoint):
    from turtle_navigator.srv._add_waypoint import AddWaypoint_Request as Request
    from turtle_navigator.srv._add_waypoint import AddWaypoint_Response as Response
