    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'turtle_navigator.msg.RobotState')
            logger.debug(
...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    def __init__(self, **kwargs):
        ...
        self.navigating = kwargs.get('navigating', bool())
    ...
    def __eq__(self, other):
        ...
        if self.current_y != other.current_y:
            return False
        if self.navigating != other.navigating:
            return False
        return True
    ...
    @builtins.property
    def navigating(self):
        """Message field 'navigating'."""
        return self._navigating

    @navigating.setter
    def navigating(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'navigating' field must be of type 'bool'"
