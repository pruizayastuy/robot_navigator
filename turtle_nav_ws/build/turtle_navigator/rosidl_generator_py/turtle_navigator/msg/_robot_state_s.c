...
bool turtle_navigator__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtle_navigator.msg._robot_state.RobotState", full_classname_dest, 44) == 0);
  }
  turtle_navigator__msg__RobotState * ros_message = _ros_message;
  {  // current_x
  ...
  {  // navigating
    PyObject * field = PyObject_GetAttrString(_pymsg, "navigating");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->navigating = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * turtle_navigator__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtle_navigator.msg._robot_state");
  ...
  {  // navigating
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->navigating ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "navigating", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
