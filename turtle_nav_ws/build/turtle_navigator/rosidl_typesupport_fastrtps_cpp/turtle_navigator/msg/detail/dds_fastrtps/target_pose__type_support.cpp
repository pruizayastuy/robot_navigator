...
#include "turtle_navigator/msg/detail/target_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_navigator::msg::TargetPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_navigator::msg::TargetPose & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_navigator::msg::TargetPose;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const turtle_navigator::msg::TargetPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_navigator::msg::TargetPose *>(
    untyped_ros_message);
...
get_message_type_support_handle<turtle_navigator::msg::TargetPose>()
{
  return &turtle_navigator::msg::typesupport_fastrtps_cpp::_TargetPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_navigator, msg, TargetPose)() {
  return &turtle_navigator::msg::typesupport_fastrtps_cpp::_TargetPose__handle;
}
