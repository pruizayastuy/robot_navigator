...
#include "turtle_navigator/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_navigator::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtle_navigator::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_navigator::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &turtle_navigator::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
